jQuery(document).ready(function ($) {
	...
	function disbale_comments_tabs() {
		...
		if (hash === "#delete") {
			jQuery("#GlobalSettingsNav > a").removeClass("active");
			jQuery("#AvengersGlobalSetting").removeClass("show");
			jQuery("#SocialLinksNav > a").addClass("active");
			jQuery("#AvengersSocialLinks").addClass("show");
			jQuery("#HelpGuideNav > a").addClass("active");
			jQuery("#HelpGuide").addClass("show");
		}
	}
